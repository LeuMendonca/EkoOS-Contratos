...
def gera_contrato(caminho,seq_contrato):
	...
	(case when ek_pessoa.cep is null then 'VAZIO'
        ...
        cnv.drawImage("C:/ekoos_contrato/funcoes/cabeçalho.jpeg",30,730,width=550)
        ...
        p = Paragraph(
            ...
            ELETROMECANICA BRASIL LEM LTDA, CNPJ 32.241.595/0001-63, ENDEREÇO: Rua Pará, 1021, Centro, Luis Eduardo Magalhães - BA, CEP 47.850-000. Denominada locadora.<br /><br />
            3.	<b>Objeto:</b><br /><br />
            {''.join(lista_produtos)}'''
        )
        p.wrapOn(cnv,500,25)
        ...
        cnv.drawImage("C:/ekoos_contrato/funcoes/cabeçalho.jpeg",30,710,width=550)
