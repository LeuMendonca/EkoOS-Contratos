...
function adicionar_item() {
  ...
  let tabela_produtos = window.document.getElementsByName('select_produto')[0]
  let medidas = window.document.querySelector("select#unid_medida")
  ...
  let seq_item_detalhe = document.createElement("input")
  seq_item_detalhe.setAttribute('type','hidden')
  seq_item_detalhe.setAttribute("name","sequencial_item")
  seq_item_detalhe.setAttribute("value","new")


  let div_select = document.createElement('div')
  div_select.setAttribute('class','col-sm-auto')
  let select = document.createElement('select')
  select.setAttribute('name','select_produto')
  ...
  input_valor.setAttribute('placeholder','Valor unitário')
  ...
  input_valor.style.marginTop = '5px'
  ...
  let div_qtd_medida = document.createElement("div")
  div_qtd_medida.setAttribute("class","col-auto")



  let div_select_medida = document.createElement("div")
  div_select_medida.setAttribute("class","col-auto")


  let select_medida = document.createElement("select")
  select_medida.setAttribute("class","form-select")
  select_medida.setAttribute("name","unid_medida")
  select_medida.setAttribute("id","unid_medida")
  select_medida.style.height = "35px"
  select_medida.style.marginTop = "5px"

  for (let c = 0 ; c < medidas.length ; c++){
    let opt_medida = document.createElement("option")
    opt_medida.text = medidas.options[c].text
    opt_medida.value = medidas.options[c].value
    select_medida.appendChild(opt_medida)
  }

  div_select_medida.appendChild(select_medida)
  ...
  campo_quantidade.style.width = '110px'
  campo_quantidade.setAttribute('name','quantidade')
  campo_quantidade.setAttribute('placeholder','Quantidade')
  ...
  div_row.appendChild(div_select_medida)
  ...
  div_row.appendChild(seq_item_detalhe)

  window.document.querySelector("div.container_items").append(div_row)
...
function remover_item(id_campo){
  ...
  const childContainerItems = window.document.querySelector(".container_items")

  if (Number(childContainerItems.childElementCount) == 1){
      document.getElementsByName("quantidade")[0].value = null
      document.getElementsByName("campo_valor")[0].value = null
      document.getElementsByName("vl_total")[0].value = null
      document.getElementsByName("select_produto")[0].value = 1000000006
      document.getElementsByName("unid_medida").value = 'Dias'

      let botaoAdicionarRemover = document.getElementsByName("buttonAdicionar")[0]
      botaoAdicionarRemover.className = "btn btn-warning btn-sm"
      botaoAdicionarRemover.setAttribute("onclick","adicionar_item()")
      botaoAdicionarRemover.value = "Adicionar"
